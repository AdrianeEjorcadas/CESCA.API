...
public static class CustomIdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        if (!configOptions.ExcludeRegisterPost)
        {
        ...
        if (!configOptions.ExcludeResendConfirmationEmailPost)
        {
        ...
        if (!configOptions.ExcludeForgotPasswordPost)
        {
        ...
        if (!configOptions.ExcludeResetPasswordPost)
        {
        ...
        if (!configOptions.Exclude2faPost)
        {
        ...
        if (!configOptions.ExcludegInfoGet)
        {
        ...
        if (!configOptions.ExcludeInfoPost)
        {
